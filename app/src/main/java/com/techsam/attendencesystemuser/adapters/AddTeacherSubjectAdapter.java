...
public class AddTeacherSubjectAdapter extends RecyclerView.Adapter<AddTeacherSubjectAdapter.ViewHolder> {
    private ArrayList<Subject> list;
    private Context context;

    public AddTeacherSubjectAdapter(ArrayList<Subject> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AddTeacherSubjectAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.checkboxteacher,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AddTeacherSubjectAdapter.ViewHolder holder, int position) {
